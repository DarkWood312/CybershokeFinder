save - True or False  # Save information about all players or not
sleep_time - float like 0.5   # Time in seconds of parsing server by server
searching_with_filters - True or False  # Find definite players using filters below or not 
